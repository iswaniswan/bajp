...
object DummyResponses {
    ...
    fun generateResponseMovies(): MoviesResponse =
        MoviesResponse(
            1,
            1000,
            generateResponseMoviesItem(),
            20000
        )

    fun generateResponseTvShows(): TvShowsResponse =
        TvShowsResponse(
            1, 1000, generateResponseTvShowsItem(), 20000
        )

    fun generateResponseMoviesItem(): ArrayList<MovieResponse> {
        ...
        list.add(
            MovieResponse(
                471498,
                "/u74DFoZGTcZ8cuHO8nvQkCqXEVP.jpg",
        ...
        list.add(
            MovieResponse(
                501929,
                "/mI2Di7HmskQQ34kz0iau6J1vr70.jpg",
        ...
        list.add(
            MovieResponse(
                631060,
                "/9tSkNmGt1K5Lgf0L0BTHHYJNz0W.jpg",
        ...
        list.add(
            MovieResponse(
                735595,
                "/JwCrbxaq0qdUTHF0TVG9VgGhPV.jpg",
        ...
        list.add(
            MovieResponse(
                597890,
                "/gn2vCmWO7jQBBto9SYuBHYZARaU.jpg",
    ...
    fun generateResponseTvShowsItem(): ArrayList<TvShowResponse> {
        ...
        list.add(
            TvShowResponse(
                80039,
                "/CrrTqw7LHafnbdH9UcK60aOZSm.jpg",
        ...
        list.add(
            TvShowResponse(
                71024,
                "/lqS90fU1IEHSbga7X6Gej5amBvR.jpg",
        ...
        list.add(
            TvShowResponse(
                119988,
                "/6USbtATMqFLkeafx3FV3wcGZTNo.jpg",
        ...
        list.add(
            TvShowResponse(
                37854,
                "/1j4vxmpsjCTIOCUAzevHF8M8aZx.jpg",
        ...
        list.add(
            TvShowResponse(
                115004,
                "/78aK4Msbr22A5PGa6PZV0pAvdwf.jpg",
        ...
        list.add(
            TvShowResponse(
                99617,
                "/uBRpPFcYAYLM7V3x6x7bP3Ucumj.jpg",
        ...
        list.add(
            TvShowResponse(
                83639,
                "/9hDXqzN5l4lBmEtb8IstXr91k8z.jpg",
        ...
        list.add(
            TvShowResponse(
                93716,
                "/yVtwJQN2uBbGF9rryXPIvuJHWzH.jpg",
        ...
        list.add(
            TvShowResponse(
                1429,
                "/1MaoMVXA4SiwtNpPVFKEd6deuVR.jpg",
    ...
    fun generateResponseMovie(): MovieDetailResponse =
        MovieDetailResponse(
            false,
    ...
    fun generateResponseTvShow(): TvShowDetailResponse =
    ...
    private val sampleGenresMovie: List<GenresItem>
        get() {
            val array = ArrayList<GenresItem>()
            array.add(
                GenresItem(28, "Action")
            )
            array.add(
                GenresItem(14, "Fantasy")
            )
            array.add(
    ...
    private val sampleCompaniesMovie: List<ProductionCompaniesItem>
        get() {
            val array = ArrayList<ProductionCompaniesItem>()
            array.add(
    ...
    private val sampleGenresTvShow: List<GenresItem>
        get() {
            val array = ArrayList<GenresItem>()
            array.add(
                GenresItem(18, "Drama")
    ...
    private val sampleCompaniesTvShow: List<ProductionCompaniesItem>
        get() {
            val array = ArrayList<ProductionCompaniesItem>()
            array.add(
                ProductionCompaniesItem(
                    19366,
                    "/vOH8dyQhLK01pg5fYkgiS31jlFm.png",
                    "ABC Studios",
                    "US"
                )
            )
            ...
            array.add(
                ProductionCompaniesItem(
                    11073,
                    "/wHs44fktdoj6c378ZbSWfzKsM2Z.png",
    ...
    private val sampleSeasons: List<SeasonsItem>
        get() {
            val array = ArrayList<SeasonsItem>()
            array.add(
                SeasonsItem(
                    "2017-09-25",
                    18,
                    ...
                    "Season 1",
                    "",
                    "/hiNyjUSTFrbMv3Sc0CxNW2o39az.jpg",
                    1
                )
            )
            array.add(
