...
object DummyModels {
    ...
    fun generateTvShowDetail(): TvShowDetail =
        TvShowDetail(
    ...
    val sampleGenresMovie: List<Genre> = listOf(
        Genre(28, "Action"),
        Genre(14, "Fantasy"),
        Genre(12, "Adventure")
    )

    val sampleCompaniesMovie: List<Company> = listOf(
    ...
    val sampleGenresTvShow: List<Genre> = listOf(
        Genre(18, "Drama")
    )

    val sampleCompaniesTvShow: List<Company> = listOf(
    ...
    val sampleSeasons: List<Season> = listOf(
